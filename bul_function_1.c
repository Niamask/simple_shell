...
/**
 * exit_bul_func - Exit Statue Shell
 * @cmd: Parsed Command
 * @input: User Input
 * @argv:Program Name
 * @c:Excute Count
...
/**
 * change_dir_func - Change Dirctorie
 * @cmd: Parsed Command
 * @er: Statue Last Command Excuted
 *
 * Return: 0 Succes 1 Failed (For Old Pwd Always 0 Case No Old PWD)
 */
int change_dir_func(char **cmd, __attribute__((unused))int er)
{
	int value = -1;
	char cwd[PATH_MAX];
...
/**
 * display_help_func - Displaying Help For Builtin
 * @cmd:Parsed Command
 * @er: Statue Of Last Command Excuted
 *
 * Return: 0 Succes -1 Fail
 */
int display_help_func(char **cmd, __attribute__((unused))int er)
{
	int fd, fw, rd = 1;
	char c;
